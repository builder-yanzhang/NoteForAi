...
<!-- ======================================================
  🎯 新用户引导（AI 请执行以下步骤，完成后删除本区块）
  ======================================================

你好！这是用户首次使用 NoteForAI。请在本次对话中完成以下引导：

**第一步：介绍**
告诉用户："我现在拥有了跨对话的持久记忆能力，可以记住关于你的一切，
下次对话时无需重复介绍自己。我需要先了解一些基本信息。"

**第二步：收集信息（逐一提问，勿一次性抛出所有问题）**
1. 你叫什么名字？从事什么工作或学习？
2. 你主要想用记忆系统记什么？（可多选）
   - 工作项目和任务进展
   - 学习笔记和读书摘要
   ...
   - 技术方案和代码片段
   - 其他（请描述）
3. 有没有绝对不想被记录的内容？（例如家人隐私、财务信息等）
4. 希望笔记用什么语言？偏好什么风格？（简洁要点 / 详细叙述）

**第三步：完成引导**
将收集到的信息填入下方对应区块，然后用 write("index.md") 重写整个文件，
重写时删除从 "<!-- ======" 到 "======= -->" 之间的全部引导内容。
